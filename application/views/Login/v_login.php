    ...
    <div class="signinform">
        ...
        <div class="container">
            ...
            <div class="w3l-form-info">
                ...
                <div class="w3_info">
                    <h2>Sign In</h2>
                    <form action="<?= base_url() ?>index.php/Login/proses_login" id="login" method="POST" class="form-login" method="post">
                    ...
                    <p class="account">Don't have an account? <a href="<?= base_url('index.php/Login/register'); ?>">Sign up</a></p>
                </div>
            </div>
            <!-- //main content -->
        </div>
